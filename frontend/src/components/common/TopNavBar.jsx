    ...
    return (
        <nav className="fixed top-0 w-full z-[100] flex justify-between items-center px-6 md:px-10 py-4 max-w-full bg-slate-950/60 backdrop-blur-xl shadow-[0_20px_40px_rgba(0,0,0,0.3)] border-b border-white/5">
            ...
            <div className="hidden md:flex gap-8 items-center font-headline tracking-tight font-semibold">
                ...
                <Link to="/career-path" className="text-slate-400 hover:text-white transition-colors duration-300">Roadmaps</Link>
                <Link to="/job-tracker" className="text-slate-400 hover:text-white transition-colors duration-300">Tracker</Link>
                <Link to="/learning-hub" className="text-slate-400 hover:text-white transition-colors duration-300">Resources</Link>
            ...
            {isMobileMenuOpen && (
                <div className="absolute top-full left-0 w-full bg-slate-950/95 backdrop-blur-xl border-b border-white/10 md:hidden flex flex-col items-center py-6 gap-6 shadow-2xl animate-in slide-in-from-top-2">
                    ...
                    <Link to="/career-path" onClick={() => setIsMobileMenuOpen(false)} className="text-slate-300 font-semibold hover:text-white">Roadmaps</Link>
                    <Link to="/job-tracker" onClick={() => setIsMobileMenuOpen(false)} className="text-slate-300 font-semibold hover:text-white">Tracker</Link>
