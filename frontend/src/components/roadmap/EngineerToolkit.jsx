  ...
  return (
    <section className="mt-32 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card 1 */}
        <div className="md:col-span-2 glass-panel dark:border-white/10 border-slate-200 bg-white/60 dark:bg-transparent rounded-xl p-8 border border-slate-200 dark:border-outline-variant/10 flex flex-col justify-between">
          <div>
            <h4 className="text-xl font-bold mb-4">Deep Learning Compute</h4>
            <p className="text-slate-600 dark:text-on-surface-variant text-sm mb-6">
              Our integration suite allows you to track GPU utilization and
              distributed training metrics directly in your roadmap.
            </p>
          </div>
          <div className="h-48 w-full bg-surface-container rounded-lg overflow-hidden relative border border-slate-200 dark:border-outline-variant/10">
        ...
        {/* Card 2 */}
        <div className="glass-panel dark:border-white/10 border-slate-200 bg-white/60 dark:bg-transparent rounded-xl p-8 border border-slate-200 dark:border-outline-variant/10">
          ...
          <p className="text-slate-600 dark:text-on-surface-variant text-sm">
            Automate your learning milestones using our proprietary CLI. Pull
            resources, submit projects, and get instant feedback.
          </p>
        ...
        {/* Card 3 */}
        <div className="glass-panel dark:border-white/10 border-slate-200 bg-white/60 dark:bg-transparent rounded-xl p-8 border border-slate-200 dark:border-outline-variant/10 text-center">
        ...
        {/* Card 4 */}
        <div className="md:col-span-2 glass-panel dark:border-white/10 border-slate-200 bg-white/60 dark:bg-transparent rounded-xl p-8 border border-slate-200 dark:border-outline-variant/10 flex items-center gap-8">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-on-surface-variant text-sm">
              Our AI analyzes your code structure, efficiency, and documentation
              quality to provide university-level grading in seconds.
            </p>
