                    ...
                    >
                        <div>
                            ...
                            <div className="flex items-baseline gap-2">
                                ...
                                {m.subtext && (
                                    <span className={`text-[0.75rem] font-bold ${m.subtext.startsWith('+') ? 'text-emerald-400' : m.subtext.includes('Neutral') ? 'text-white/40' : 'text-rose-400'}`}>
                                        {m.subtext}
                                    </span>
                                )}
                            </div>
                ...
                <div className="lg:col-span-7 p-6 rounded-2xl bg-[#1e1f23]/60 border border-white/5 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <span className="text-[0.6rem] text-white/30 uppercase tracking-widest font-black">Skills learned</span>
                        </div>
                    </div>
                        ...
                        {activeRoadmap.stages.map((stage, idx) => {
                            ...
                            return (
                                <div key={idx} className="relative group">
                                    {/* Icon Indicator dot */}
                                    <div className={`absolute -left-[34px] top-1 w-6 h-6 rounded-full border-2 flex items-center justify-center bg-[#17181c] z-10 transition-all duration-300
                                    ...
                                    `}>
                                        {isCompleted ? (
                                            <span
                                                ...
                                                style={{ fontSize: '12px', fontVariationSettings: "'FILL' 1, 'wght' 700", display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                            >check</span>
                                        ) : isActive ? (
                                            <div className="w-2 h-2 rounded-full bg-violet-500" />
                                        ) : (
                                            <span
                                                className="material-symbols-outlined text-white/30 leading-[0]"
                                                style={{ fontSize: '12px', fontVariationSettings: "'FILL' 0, 'wght' 300", display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                            >upcoming</span>
                                        )}
                                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                >
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[0.7rem] text-white/30 font-medium">Discover new roadmaps</span>
                    </div>
                </div>
            </div>
