        ...
        <div className="lg:col-span-12 relative h-64 rounded-xl overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-slate-950 via-slate-950/80 to-transparent flex items-center p-12">
            <div className="max-w-xl">
              <h3 className="text-3xl font-headline font-black text-slate-900 dark:text-white mb-4">
                Architectural Recommendation
              </h3>
              <p className="text-slate-300 leading-relaxed mb-6 font-body">
                Your current skill profile shows strong algorithmic foundations
                but lacks the "Productionization" layer. Focusing on TensorFlow
                2.x and distributed training will increase your market valuation
                by an estimated{" "}
                <span className="text-primary font-bold">22%</span>.
              </p>
              <a
                className="inline-flex items-center gap-2 text-primary font-bold uppercase tracking-widest text-xs hover:gap-4 transition-all font-label"
                href="#"
              >
