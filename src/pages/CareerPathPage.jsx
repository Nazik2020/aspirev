    ...
    return (
        <div className="w-full space-y-10">
            ...
            <div className="space-y-1">
                <p className="text-[0.65rem] uppercase tracking-[0.2em] font-bold text-white/25 flex items-center gap-2">
                    <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>auto_awesome</span>
                    The Luminescent Architect of Careers
                </p>
            ...
            <div className="rounded-2xl border border-white/8 bg-[#1e1f23] p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center gap-6 justify-between">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
                    <input
                        ...
                        className="flex-1 md:w-56 bg-[#14151a] border border-white/10 rounded-xl px-4 py-2.5 text-sm
                                   text-white/70 placeholder:text-white/25 focus:outline-none focus:border-primary/40 transition-all"
                    />
                    <button className="shrink-0 px-5 py-2.5 rounded-xl bg-gradient-to-br from-primary-container to-primary text-white text-sm font-bold
                                       hover:opacity-90 hover:scale-105 transition-all duration-200 whitespace-nowrap">
                        Notify Me
                    </button>
                </div>
            </div>
