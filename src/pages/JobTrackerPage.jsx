        ...
        <div className="w-full space-y-8 relative">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <div className="flex gap-3 w-full md:w-auto relative">
                    ...
                    <div className="relative flex-1 md:flex-none" ref={filterDropdownRef}>
                        ...
                        {filterDropdownOpen && (
                            <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[#141519] border border-white/10 p-1.5 shadow-[0_15px_30px_rgba(0,0,0,0.5)] z-30">
                                <button
                                    onClick={() => {
                                        setStatusFilter('All');
                                        setFilterDropdownOpen(false);
            ...
            {showAddModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    {/* Form Container */}
                    <div className="relative z-10 w-full max-w-xl rounded-3xl bg-[#131417] border border-white/10 p-8 md:p-10 shadow-[0_30px_70px_rgba(0,0,0,0.85)]">
                        ...
                        <div className="text-center space-y-1 mb-8">
                            <h2 className="text-2xl font-extrabold text-white tracking-tight">Add New Application</h2>
                        ...
                        <form onSubmit={handleSave} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    className="w-full bg-[#1c1d22]/50 border border-white/5 rounded-xl px-4 py-3 text-[0.85rem] text-white/80 placeholder:text-white/20 focus:outline-none focus:border-primary/45 transition-all resize-none"
                                />
                            </div>
            ...
            {selectedApp && (
                <div className="fixed inset-0 z-50 flex justify-end">
                    ...
                    {/* Side Drawer Body */}
                    <div className="relative z-10 w-full max-w-md bg-[#17181c] border-l border-white/10 h-full shadow-[-10px_0_40px_rgba(0,0,0,0.6)] p-6 md:p-8 flex flex-col justify-between overflow-y-auto">
                                    ...
                                    <div className="flex items-center gap-2 bg-[#1c1d22] border border-transparent rounded-xl px-3.5 py-3 text-[0.85rem] text-white/80">
                                        ...
                                        {isEditing ? (
                                            <input
                                                ...
                                                className="w-full bg-transparent focus:outline-none text-white/85 text-[0.85rem]"
                                                placeholder="mm/dd/yyyy"
                                            />
                                        ) : (
